#ifndef MYSTERIO_OMNET_UAVS_MODULOCOMUNICACAOALPHA_H_
#define MYSTERIO_OMNET_UAVS_MODULOCOMUNICACAOALPHA_H_
...
class ModuloComunicacaoAlpha : public cSimpleModule {
  protected:
